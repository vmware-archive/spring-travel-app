...
public class HotelsController {
    ...
    @RequestMapping(value = "/busyhotels", method = RequestMethod.GET)
    public String listBusyHotels(SearchCriteria criteria, Model model) {
        List<Hotel> hotels = bookingService.findBusyHotels();
        model.addAttribute(hotels);
        return "hotels/busyhotels";
    }
